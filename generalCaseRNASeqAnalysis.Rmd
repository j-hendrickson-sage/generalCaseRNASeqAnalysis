...
joinedMetadata = joinMetadata(biospecimenName="UCI_3xTg-AD_biospecimen_metadata.csv", individualName="UCI_3xTg-AD_individual_metadata.csv", metadataManifest=metadataManifest)

joinedMetadata.to_csv('UCI_3xTg-AD_joinedMetadata.csv', index=False)
